    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 text-white flex flex-col">
      ...
      <header className="flex items-center justify-between px-8 py-5 max-w-7xl mx-auto w-full">
        ...
        <div className="flex gap-3">
          ...
          <Link to="/register" className="px-4 py-2 rounded-lg bg-blue-600 hover:bg-blue-500 text-sm font-semibold transition-colors">
            Get started
          </Link>
        </div>
      </header>
      ...
      {/* Hero */}
      <section className="flex-1 flex flex-col items-center justify-center text-center px-6 py-24 gap-6 max-w-3xl mx-auto">
        ...
        <div className="flex gap-4 mt-2">
          <Link to="/register" className="px-6 py-3 rounded-xl bg-blue-600 hover:bg-blue-500 font-semibold text-sm transition-colors shadow-lg">
            Get started free
          </Link>
          <Link to="/login" className="px-6 py-3 rounded-xl border border-slate-600 hover:border-slate-400 font-medium text-sm transition-colors">
            Sign in
          </Link>
        </div>
      </section>
